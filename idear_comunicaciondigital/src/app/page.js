  ...
  return (
    <main className="m-4 flex flex-col items-center justify-center">
     ...
     <div className="flex flex-col justify-center items-center m-4 mb-12  ">
      ...
      <div className="bg-[#fcc82d]  w-[90%]  sm:w-[66%] rotate-1 rounded-lg mt-4 shadow-lg  border-4   border-yellow-400 rounded-xl overflow-hidden animate-border-color-change">
        <div className="p-8 ">
          ...
          <p className="text-gray-700 text-xl ">
            Soy <Link className="text-gray-900 text-2xl mb-4"  href="https://www.instagram.com/m.florenciasosa"> @m.florenciasosa</Link> y junto a mi equipo de jóvenes profesionales podemos ayudarte en tu comunicación digital.
          </p>
...
<footer className="bg-yellow-200  rounded-xl text-slate-900 py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col items-start">
          <div className="flex items-center mb-4">
             
            <span className="text-slate-900 font-bold text-lg">IDEAR</span>
          </div>
        ...
        <div className="flex flex-col items-start">
          ...
          <nav className="space-y-2 flex flex-col items-start">
            <Link className="hover:text-yellow-900 px-1 transition-colors" href="#">
              Home
            </Link>
            <Link className="hover:text-yellow-900 px-1 transition-colors" href="#">
            ...
            <Link className="hover:yellow-900 px-1 transition-colors" href="#">
              Artículos
            </Link>
            <Link className="hover:yellow-900 px-1 transition-colors" href="#">
              Contacto
